(function(global){
  ...
  */
  ...
  PubSub.prototype.unsubscribe = function(channel, fn){
    if (this.channels[channel] !== undefined) {
      var index = this.channels[channel].indexOf(fn);
  ...
  Delivery.prototype.destroy = function() {
    pubSub.unsubscribeAll();
    this.socket.removeAllListeners('send.success');
    this.socket.removeAllListeners('receive.start');
    this.socket.removeAllListeners('delivery.connect');
  }
